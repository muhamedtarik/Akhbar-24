  ...
  <div class="container">
    <div class="d-flex justify-content-between align-items-center">
      ...
      <div class="mobile-nav__logo">
        <a href="/" class="mobile-nav__logo__img"><img src="/img/mobile/logo.png" alt=""></a>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form method="GET" action="{{ route('search.show', ['slug' => 'title']) }}">
          <input class="form-control" type="text" name="keyword" placeholder="البحث">
