<div class="s24-side-news-tabs mt-4">
  <ul class="s24-side-news-tabs__tabs__list nav nav-pills" id="pills-tab" role="tablist">
  ...
  <div class="tab-content" id="pills-tabContent">
    <div class="tab-pane fade show active px-2" id="mostread" role="tabpanel" aria-labelledby="mostread-tab">
      @foreach ($mostRead as $item)
        <div class="s24-side-news-tabs__item py-2">
          <a class="s24-side-news-tabs__item--link" href="{{ route('items.show', $item['id']) }}">
            <div class="row">
              <div class="col-5 pl-0">
                <div class="s24-side-news-tabs__item__img">
                  <img src="{{ $item['image'] }}" alt="{{ $item['title'] }}"
                       onerror="if (this.src != 'error.jpg') this.src = '/img/desktop/defaultimg.png';">
                </div>
              </div>
              <div class="col-7 pr-2">
                <p class="s24-side-news-tabs__item--text text-right">
                  {{ $item['title'] }}
                </p>
              </div>
            </div>
