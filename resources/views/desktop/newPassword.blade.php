              ...
              <div class="activeAccount mb-5">
                ...
                <div class="form-group">
                  <input type="email" class="form-control" id="exampleFormControlInput1"
                         style="width:85% ; font-weight:bold" value="كلمة المرور الجديدة">
                </div>
                <div class="form-group">
                  <input type="email" class="form-control" id="exampleFormControlInput1"
                         style="width:85% ; font-weight:bold" placeholder="تاكيد كلمة المرور الجديدة">
                </div>
                <button class="mt-3">حفظ التغييرات</button>
              </div>
            </div>
